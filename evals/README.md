...
- **Tuned, not held out.** Extraction (32/36) and fit scoring (27/28) were tuned against their own fixtures after a failed capture; routing (26/26) was tuned against its own cases over five rounds. Only the first round of each prompt version was blind, and those are the low numbers in this file.
